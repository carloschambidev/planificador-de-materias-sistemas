      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 items-stretch">
        ...
        <div className="flex flex-col gap-4 w-full h-full">
          <button
            ...
            className="group flex-1 min-h-[300px] rounded-2xl border-2 border-dashed border/80 hover:border-indigo-500/80 bg-surface/40 hover:bg-indigo-950/20 transition-all text-secondary hover:text-indigo-200 shadow-md hover:shadow-indigo-500/10 cursor-pointer flex flex-col items-center justify-center gap-3.5 p-6"
          >
            <div className="p-4 rounded-full bg-surface-hover/80 group-hover:bg-indigo-600/20 text-secondary group-hover:text-indigo-400 transition-colors">
              <PlusCircle size={36} className="group-hover:scale-110 transition-transform duration-200" />
            </div>
            <div className="text-center">
              <span className="block text-sm font-bold text-primary group-hover:text-white">
